...
Assignment: Assignment 2 - Basic Sequential Web Proxy
...
The user will be able to take a look at the ProxyLog.txt file as it contains the Date, time, browser ip address, browser url, size
